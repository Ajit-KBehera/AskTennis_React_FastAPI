...
@lru_cache(maxsize=256)
def get_ranking_context(question: str, year: Optional[int] = None, tour: Optional[str] = None) -> Dict[str, Any]:
    """
...
def get_ranking_sql_approach(question_type: str, tour: str = "ATP", year: Optional[int] = None) -> Dict[str, Any]:
    """
...
STOP_WORDS = {
    "Grand", "Slam", "Open", "Masters", "Final", "Tour", "ATP", "WTA",
    "French", "Australian", "Wimbledon", "Roland", "Garros", "Championship",
    "Tournament", "Tourney", "Event", "Match", "Round", "Quarter", "Semi"
}
