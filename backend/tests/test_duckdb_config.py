...
from app.infrastructure.database.duckdb_config import DuckDBConfig
from app.infrastructure.database.sqlite_config import SQLiteConfig
...
class TestDuckDBConfig:
    ...
    @patch("app.infrastructure.database.duckdb_config.create_engine")
