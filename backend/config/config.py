...
class Config:
    ...
    def _get_api_key(self) -> str:
        ...
        env_vars = [k for k in os.environ.keys() if "GOOGLE" in k or "API" in k or "KEY" in k]
        print(f"DEBUG: Available environment variables containing 'GOOGLE', 'API', or 'KEY': {env_vars}")
