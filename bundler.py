...
# Folders to ignore
IGNORE_DIRS = {'.git', '__pycache__', 'venv', 'env', '.idea', '.vscode', 'node_modules', 'dist', 'build', 'coverage', 'logs', '.md', '.gitignore', '.env', '.DS_Store', '.db'} 
# Specific files to ignore
IGNORE_FILES = {'package-lock.json', 'yarn.lock'} 
# File extensions to include
INCLUDE_EXTS = {'.py', '.json', '.html', '.css', '.sql', '.txt', '.js', '.jsx', '.ts', '.tsx'}
# -----------------------------------------------
